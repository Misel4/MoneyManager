...
public class SpendingPieFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.spending_pie_fragment_layout,container,false);
    ...
    public void setupPieChart() throws ParseException {
        ...
        Cursor values = myDb.getExpenditure();
